...
public class ProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"A+", "O+", "B+","AB+","A-","O-","B-","AB-"};
    ...
    private void SaveUserInformation() {
        ...
        String spinner_=spinner.getSelectedItem().toString().trim();


        userinformation userInformation = new userinformation(name_,contact_,spinner_,lat,lon);
        FirebaseUser user =firebaseAuth.getCurrentUser();
    ...
    private class PlacesTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... place) {
            ...
            String key = "key= AIzaSyBG1Z2FUeT9jI0r54Oh7e7PZnp1sLwwtFw ";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_profile2, menu);
        return true;
    }
